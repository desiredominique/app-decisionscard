...
pagina_selecionada = st.sidebar.radio('Selecione uma página', ['Análise Exploratória', 'Análise por Períodos'])

if pagina_selecionada == 'Análise Exploratória':
    pagina_exploratoria()
elif pagina_selecionada == 'Análise por Períodos':
    pagina_periodos()